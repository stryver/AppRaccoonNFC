  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.menu}>
        <View
          style={[styles.menuItem, active === "Read" && styles.activeMenuItem]}
        >
          <Text
        ...
        <View
          style={[styles.menuItem, active === "Write" && styles.activeMenuItem]}
        >
        ...
        <View
          style={[
            styles.menuItem,
            active === "Advanced" && styles.activeMenuItem,
          ]}
        >
